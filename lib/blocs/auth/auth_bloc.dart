...
class GoogleLoginRequested extends AppAuthEvent {}
...
class AuthBloc extends Bloc<AppAuthEvent, AppAuthState> {
  ...
  Future<void> _onGoogleLogin(GoogleLoginRequested event, Emitter<AppAuthState> emit) async {
    emit(AppAuthLoading());
    try {
      ...
      emit(AppAuthFailure('Error con Google: $e'));
    }
  }
