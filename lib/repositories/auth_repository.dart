...
class AuthRepository {
  ...
  Future<void> signInWithGoogle() async {
    try {
      ...
      if (googleUser == null) throw const AppAuthException('Inicio cancelado');
      final googleAuth = await googleUser.authentication;
      if (googleAuth.idToken == null) throw const AppAuthException('Token no disponible');
      ...
      throw AppAuthException('Error con Google: $e');
    }
  }
